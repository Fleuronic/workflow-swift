...
extension AnyWorkflowConvertible {
    ...
    public func rendered<Parent>(in context: RenderContext<Parent>, key: String = "0") -> Rendering where Output: WorkflowAction, Output.WorkflowType == Parent {
        return asAnyWorkflow().render(context: context, key: key, outputMap: { $0 })
    }

    public func rendered<Parent, Action>(in context: RenderContext<Parent>, key: String = "0", outputMap: @escaping (Output) -> Action) -> Rendering where Action: WorkflowAction, Action.WorkflowType == Parent {
        return asAnyWorkflow().render(context: context, key: key, outputMap: { outputMap($0) })
    }

    public func rendered<Parent>(in context: RenderContext<Parent>, key: String = "0") -> Rendering where Output == AnyWorkflowAction<Parent> {
        return asAnyWorkflow().render(context: context, key: key, outputMap: { $0 })
    }
}
...
extension AnyWorkflowConvertible where Output == Never {
    ...
    ///
    /// - Returns: The `Rendering` generated by the workflow.
    public func rendered<T>(in context: RenderContext<T>, key: String = "0") -> Rendering {
...
extension AnyWorkflowConvertible where Rendering == Void {
    public func running<Parent, Action>(in context: RenderContext<Parent>, key: String = "0", outputMap: @escaping (Output) -> Action) where Action: WorkflowAction, Action.WorkflowType == Parent {
...
extension AnyWorkflowConvertible where Rendering == Void, Output: WorkflowAction {
    public func running<Parent>(in context: RenderContext<Parent>, key: String = "0") where Output.WorkflowType == Parent {
